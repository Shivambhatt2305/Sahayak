...
export function StudentChatbotInterface() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      const result = await answerStudentQuery(values);
            ...
            <ScrollArea className="h-full p-6" ref={scrollAreaRef}>
                ...
                {messages.length === 0 && (
                    <div className="text-center text-muted-foreground pt-16">
                        ...
                        <p className="mt-2">Ask a question to get started. For example, "Can you explain mitosis to me?"</p>
                    </div>
                )}
